...
3. Color classification, determine all the colors. Model -- resnet34 trained with python-lightning, loss -- binary cross entropy. Two approaches: choose checkpoint with (1) the greatest recall or (2) the least loss. 1 one: recall 68%, precision 86%. 2 one: recall 32%, precision 70%. As I trained the model, precision was decreasing whereas recall was inscreasing.
